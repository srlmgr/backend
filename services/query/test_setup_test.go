...
func resetTestTables(t *testing.T) {
	...
	if _, err := testPool.Exec(
		context.Background(),
		"TRUNCATE TABLE racing_sims, series, point_systems, seasons, tracks, track_layouts, events, car_manufacturers, car_brands, car_models, drivers, teams RESTART IDENTITY CASCADE",
	); err != nil {
