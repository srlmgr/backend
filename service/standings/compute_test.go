...
func TestComputeCarriesStandingsAcrossMissingEvents(t *testing.T) {
	...
	assertComputedStanding(t, actual[0], 1, &StandingData{
		Position:       1,
		PrevPosition:   2,
		TotalPoints:    17,
		BonusPoints:    0,
	...
	assertComputedStanding(t, actual[1], 2, &StandingData{
		Position:       2,
		PrevPosition:   1,
		TotalPoints:    15,
		BonusPoints:    1,
...
func TestComputeCountsMultiRaceParticipationPerRace(t *testing.T) {
	...
	assertComputedStanding(t, actual[0], 2, &StandingData{
		Position:       1,
		PrevPosition:   0,
		TotalPoints:    10,
		BonusPoints:    5,
	...
	assertComputedStanding(t, actual[1], 1, &StandingData{
		Position:       2,
		PrevPosition:   0,
		TotalPoints:    5,
		BonusPoints:    0,
