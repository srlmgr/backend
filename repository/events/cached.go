...
type cachedRepository struct {
	Repository
	byID *cache.Cache[int32, *models.Event]
}

// NewCached wraps repo with a read-through cache keyed by event ID.
func NewCached(repo Repository, byID *cache.Cache[int32, *models.Event]) Repository {
