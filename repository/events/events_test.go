...
func TestRepositoryCreateLoadByIDLoadAll(t *testing.T) {
	...
	created := seedEvent(t, repo, season.ID, pointSystem.ID, trackLayout.ID, "Round 1", 1)
...
func TestRepositoryLoadBySeasonID(t *testing.T) {
	...
	eventA := seedEvent(t, repo, seasonA.ID, pointSystem.ID, trackLayout.ID, "Round A", 1)
	_ = seedEvent(t, repo, seasonB.ID, pointSystem.ID, trackLayout.ID, "Round B", 2)
...
func TestRepositoryLoadByGridID(t *testing.T) {
	...
	track := testhelpers.SeedTrack(t, "Track A")
	trackLayout := testhelpers.SeedTrackLayout(t, track.ID, "Layout A")
	event := seedEvent(t, repo, season.ID, pointSystem.ID, trackLayout.ID, "Round 1", 1)
