...
require (
	buf.build/gen/go/srlmgr/api/connectrpc/go v1.19.1-20260405104603-04981ed28226.2
	buf.build/gen/go/srlmgr/api/protocolbuffers/go v1.36.11-20260405104603-04981ed28226.1
