...
require (
	buf.build/gen/go/srlmgr/api/connectrpc/go v1.19.2-20260518064456-d89ab3b463e8.1
	buf.build/gen/go/srlmgr/api/protocolbuffers/go v1.36.11-20260518064456-d89ab3b463e8.1
