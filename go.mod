...
require (
	buf.build/gen/go/srlmgr/api/connectrpc/go v1.19.1-20260406053031-4a79b84bf5e0.2
	buf.build/gen/go/srlmgr/api/protocolbuffers/go v1.36.11-20260406053031-4a79b84bf5e0.1
