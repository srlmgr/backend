...
require (
	buf.build/gen/go/srlmgr/api/connectrpc/go v1.19.2-20260516121505-b1c640a456d6.1
	buf.build/gen/go/srlmgr/api/protocolbuffers/go v1.36.11-20260516121505-b1c640a456d6.1
