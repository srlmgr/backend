...
require (
	buf.build/gen/go/srlmgr/api/connectrpc/go v1.19.1-20260318091405-8243446d567e.2
...
require (
	buf.build/gen/go/srlmgr/api/protocolbuffers/go v1.36.11-20260318091405-8243446d567e.1 // indirect
