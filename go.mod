...
require (
	buf.build/gen/go/srlmgr/api/connectrpc/go v1.20.0-20260613084544-a333ffe8cbc2.1
	buf.build/gen/go/srlmgr/api/protocolbuffers/go v1.36.11-20260613084544-a333ffe8cbc2.1
