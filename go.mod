...
require (
	buf.build/gen/go/srlmgr/api/connectrpc/go v1.20.0-20260525180703-bc47a144a1f6.1
	buf.build/gen/go/srlmgr/api/protocolbuffers/go v1.36.11-20260525180703-bc47a144a1f6.1
