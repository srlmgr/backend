...
require (
	buf.build/gen/go/srlmgr/api/connectrpc/go v1.19.2-20260517055541-adfb1a171c98.1
	buf.build/gen/go/srlmgr/api/protocolbuffers/go v1.36.11-20260517055541-adfb1a171c98.1
