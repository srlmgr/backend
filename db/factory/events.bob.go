...
type eventR struct {
	...
	PointSystem           *eventRPointSystemR
...
type eventRPointSystemR struct {
...
func (o *EventTemplate) Create(ctx context.Context, exec bob.Executor) (*models.Event, error) {
	...
	var rel4 *models.PointSystem

	if o.r.PointSystem == nil {
		if parentModel, found := mInCreation["point_systems:events:events.events_point_system_id_fk"]; found {
	...
	if rel4 == nil {
		if o.r.PointSystem == nil {
			EventMods.WithNewPointSystem().Apply(ctx, o)
		}

		if o.r.PointSystem.o.alreadyPersisted {
			rel4 = o.r.PointSystem.o.Build()
		} else {
			rel4, err = o.r.PointSystem.o.Create(ctx, exec)
			if err != nil {
				return nil, err
			}
		}
	...
	opt.PointSystemID = omit.From(rel4.ID)

	var rel5 *models.Season

	if o.r.Season == nil {
		if parentModel, found := mInCreation["seasons:events:events.events_season_id_fk"]; found {
	...
	var rel6 *models.TrackLayout

	if o.r.TrackLayout == nil {
		if parentModel, found := mInCreation["track_layouts:events:events.events_track_layout_id_fk"]; found {
	...
	if rel6 == nil {
		...
		if o.r.TrackLayout.o.alreadyPersisted {
			rel6 = o.r.TrackLayout.o.Build()
		} else {
			rel6, err = o.r.TrackLayout.o.Create(ctx, exec)
			if err != nil {
				return nil, err
			}
		}
	...
	opt.TrackLayoutID = omit.From(rel6.ID)
	...
	newMInCreation["events:booking_entries:booking_entries.booking_entries_event_id_fk"] = m
	newMInCreation["events:event_driver_standings:event_driver_standings.event_driver_standings_event_id_fk"] = m
	newMInCreation["events:event_processing_audit:event_processing_audit.event_processing_audit_event_id_fk"] = m
	newMInCreation["events:event_team_standings:event_team_standings.event_team_standings_event_id_fk"] = m
	newMInCreation["events:races:races.races_event_id_fk"] = m

	ctx = modelsInCreationCtx.WithValue(ctx, newMInCreation)

	m.R.PointSystem = rel4
	m.R.Loaded.PointSystem = true
	m.R.Season = rel5
	m.R.Loaded.Season = true
	m.R.TrackLayout = rel6
...
func (m eventMods) RandomizeAllColumns(f *faker.Faker) EventMod {
	return EventModSlice{
		...
		EventMods.RandomPointSystemID(f),
...
// Set the model columns to this value
func (m eventMods) PointSystemID(val int32) EventMod {
	return EventModFunc(func(_ context.Context, o *EventTemplate) {
...
// Set the Column from the function
func (m eventMods) PointSystemIDFunc(f func() int32) EventMod {
	return EventModFunc(func(_ context.Context, o *EventTemplate) {
		o.PointSystemID = f
	})
}
...
// Clear any values for the column
func (m eventMods) UnsetPointSystemID() EventMod {
	return EventModFunc(func(_ context.Context, o *EventTemplate) {
		o.PointSystemID = nil
	})
}
...
// Generates a random value for the column using the given faker
// if faker is nil, a default faker is used
func (m eventMods) RandomPointSystemID(f *faker.Faker) EventMod {
	return EventModFunc(func(_ context.Context, o *EventTemplate) {
...
func (m eventMods) WithPointSystem(rel *PointSystemTemplate) EventMod {
	return EventModFunc(func(ctx context.Context, o *EventTemplate) {
		o.r.PointSystem = &eventRPointSystemR{
			o: rel,
		}
	})
}

func (m eventMods) WithNewPointSystem(mods ...PointSystemMod) EventMod {
	return EventModFunc(func(ctx context.Context, o *EventTemplate) {
...
func (m eventMods) WithExistingPointSystem(em *models.PointSystem) EventMod {
	return EventModFunc(func(ctx context.Context, o *EventTemplate) {
		o.r.PointSystem = &eventRPointSystemR{
...
func (m eventMods) WithoutPointSystem() EventMod {
	return EventModFunc(func(ctx context.Context, o *EventTemplate) {
		o.r.PointSystem = nil
	})
}
