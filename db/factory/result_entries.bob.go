...
type resultEntryR struct {
	...
	CarModelVariant *resultEntryRCarModelVariantR
...
type resultEntryRCarModelVariantR struct {
...
func ensureCreatableResultEntry(m *models.ResultEntrySetter) {
	if m.RaceGridID.IsUnset() {
		val := random_int32(nil)
		m.RaceGridID = omit.From(val)
	}
	if m.FinishPosition.IsUnset() {
		val := random_int32(nil)
		m.FinishPosition = omit.From(val)
	}
}
...
func (o *ResultEntryTemplate) insertOptRels(ctx context.Context, exec bob.Executor, m *models.ResultEntry) error {
	...
	isCarModelVariantDone, _ := resultEntryRelCarModelVariantCtx.Value(ctx)
	if !isCarModelVariantDone && o.r.CarModelVariant != nil {
		ctx = resultEntryRelCarModelVariantCtx.WithValue(ctx, true)
...
func (o *ResultEntryTemplate) Create(ctx context.Context, exec bob.Executor) (*models.ResultEntry, error) {
	...
	if o.r.RaceGrid == nil {
		if parentModel, found := mInCreation["race_grids:result_entries:result_entries.result_entries_race_grid_id_fk"]; found {
			if pModel, ok := parentModel.(*models.RaceGrid); ok {
				rel3 = pModel
			}
		}
	}
...
func (m resultEntryMods) RandomizeAllColumns(f *faker.Faker) ResultEntryMod {
	return ResultEntryModSlice{
		...
		ResultEntryMods.RandomCarModelVariantID(f),
...
// Set the model columns to this value
func (m resultEntryMods) CarModelVariantID(val null.Val[int32]) ResultEntryMod {
	return ResultEntryModFunc(func(_ context.Context, o *ResultEntryTemplate) {
...
// Set the Column from the function
func (m resultEntryMods) CarModelVariantIDFunc(f func() null.Val[int32]) ResultEntryMod {
	return ResultEntryModFunc(func(_ context.Context, o *ResultEntryTemplate) {
...
// Clear any values for the column
func (m resultEntryMods) UnsetCarModelVariantID() ResultEntryMod {
	return ResultEntryModFunc(func(_ context.Context, o *ResultEntryTemplate) {
...
// if faker is nil, a default faker is used
// The generated value is sometimes null
func (m resultEntryMods) RandomCarModelVariantID(f *faker.Faker) ResultEntryMod {
	return ResultEntryModFunc(func(_ context.Context, o *ResultEntryTemplate) {
...
// if faker is nil, a default faker is used
// The generated value is never null
func (m resultEntryMods) RandomCarModelVariantIDNotNull(f *faker.Faker) ResultEntryMod {
	return ResultEntryModFunc(func(_ context.Context, o *ResultEntryTemplate) {
		o.CarModelVariantID = func() null.Val[int32] {
			if f == nil {
				f = &defaultFaker
...
func (m resultEntryMods) WithCarModelVariant(rel *CarModelVariantTemplate) ResultEntryMod {
	return ResultEntryModFunc(func(ctx context.Context, o *ResultEntryTemplate) {
		o.r.CarModelVariant = &resultEntryRCarModelVariantR{
			o: rel,
		}
	})
}

func (m resultEntryMods) WithNewCarModelVariant(mods ...CarModelVariantMod) ResultEntryMod {
	return ResultEntryModFunc(func(ctx context.Context, o *ResultEntryTemplate) {
...
func (m resultEntryMods) WithExistingCarModelVariant(em *models.CarModelVariant) ResultEntryMod {
	return ResultEntryModFunc(func(ctx context.Context, o *ResultEntryTemplate) {
		o.r.CarModelVariant = &resultEntryRCarModelVariantR{
...
func (m resultEntryMods) WithoutCarModelVariant() ResultEntryMod {
	return ResultEntryModFunc(func(ctx context.Context, o *ResultEntryTemplate) {
