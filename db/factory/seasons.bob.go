...
type seasonR struct {
	...
	SeasonCarModelVariants []*seasonRSeasonCarModelVariantsR
	SeasonDriverStandings  []*seasonRSeasonDriverStandingsR
	SeasonDrivers          []*seasonRSeasonDriversR
...
type seasonRSeasonCarModelVariantsR struct {
	number int
...
type seasonRSeasonDriversR struct {
	number int
...
func ensureCreatableSeason(m *models.SeasonSetter) {
	if m.SeriesID.IsUnset() {
		val := random_int32(nil)
		m.SeriesID = omit.From(val)
	}
	if m.PointSystemID.IsUnset() {
		val := random_int32(nil)
		m.PointSystemID = omit.From(val)
	}
	if m.Name.IsUnset() {
...
func (o *SeasonTemplate) insertOptRels(ctx context.Context, exec bob.Executor, m *models.Season) error {
	...
	isSeasonCarModelVariantsDone, _ := seasonRelSeasonCarModelVariantsCtx.Value(ctx)
	if !isSeasonCarModelVariantsDone && o.r.SeasonCarModelVariants != nil {
		ctx = seasonRelSeasonCarModelVariantsCtx.WithValue(ctx, true)
		for _, r := range o.r.SeasonCarModelVariants {
			if r.o.alreadyPersisted {
				...
				err = m.AttachSeasonCarModelVariants(ctx, exec, rel4...)
				if err != nil {
					return err
				}
			}
	...
	if !isSeasonDriverStandingsDone && o.r.SeasonDriverStandings != nil {
		...
		for _, r := range o.r.SeasonDriverStandings {
			if r.o.alreadyPersisted {
				...
				err = m.AttachSeasonDriverStandings(ctx, exec, rel5...)
				if err != nil {
					return err
				}
			}
	...
	isSeasonDriversDone, _ := seasonRelSeasonDriversCtx.Value(ctx)
	if !isSeasonDriversDone && o.r.SeasonDrivers != nil {
		ctx = seasonRelSeasonDriversCtx.WithValue(ctx, true)
		for _, r := range o.r.SeasonDrivers {
			if r.o.alreadyPersisted {
				...
				err = m.AttachSeasonDrivers(ctx, exec, rel6...)
				if err != nil {
					return err
				}
			}
	...
	if !isSeasonTeamStandingsDone && o.r.SeasonTeamStandings != nil {
		...
		for _, r := range o.r.SeasonTeamStandings {
			if r.o.alreadyPersisted {
				...
				err = m.AttachSeasonTeamStandings(ctx, exec, rel7...)
				if err != nil {
					return err
				}
			}
	...
	if !isTeamsDone && o.r.Teams != nil {
		...
		for _, r := range o.r.Teams {
			if r.o.alreadyPersisted {
				...
				err = m.AttachTeams(ctx, exec, rel10...)
				if err != nil {
					return err
				}
			}
...
func (o *SeasonTemplate) Create(ctx context.Context, exec bob.Executor) (*models.Season, error) {
	...
	var rel8 *models.PointSystem

	if o.r.PointSystem == nil {
		if parentModel, found := mInCreation["point_systems:seasons:seasons.seasons_point_system_id_fk"]; found {
			if pModel, ok := parentModel.(*models.PointSystem); ok {
				rel8 = pModel
			}
		}
	}
	...
	if rel8 == nil {
		...
		if o.r.PointSystem.o.alreadyPersisted {
			rel8 = o.r.PointSystem.o.Build()
		} else {
			rel8, err = o.r.PointSystem.o.Create(ctx, exec)
			if err != nil {
				return nil, err
			}
		}
	...
	opt.PointSystemID = omit.From(rel8.ID)

	var rel9 *models.Series

	if o.r.Series == nil {
		if parentModel, found := mInCreation["series:seasons:seasons.seasons_series_id_fk"]; found {
			if pModel, ok := parentModel.(*models.Series); ok {
				rel9 = pModel
			}
		}
	}
	...
	if rel9 == nil {
		...
		if o.r.Series.o.alreadyPersisted {
			rel9 = o.r.Series.o.Build()
		} else {
			rel9, err = o.r.Series.o.Create(ctx, exec)
			if err != nil {
				return nil, err
			}
		}
	...
	opt.SeriesID = omit.From(rel9.ID)
	...
	newMInCreation["seasons:event_driver_standings:event_driver_standings.event_driver_standings_season_id_fk"] = m
	newMInCreation["seasons:event_team_standings:event_team_standings.event_team_standings_season_id_fk"] = m
	newMInCreation["seasons:events:events.events_season_id_fk"] = m
	newMInCreation["seasons:season_car_classes:season_car_classes.season_car_classes_season_id_fk"] = m
	newMInCreation["seasons:season_car_model_variants:season_car_model_variants.season_car_model_variants_season_id_fk"] = m
	newMInCreation["seasons:season_driver_standings:season_driver_standings.season_driver_standings_season_id_fk"] = m
	newMInCreation["seasons:season_drivers:season_drivers.season_drivers_season_id_fk"] = m
	newMInCreation["seasons:season_team_standings:season_team_standings.season_team_standings_season_id_fk"] = m
	newMInCreation["seasons:teams:teams.teams_season_id_fk"] = m

	ctx = modelsInCreationCtx.WithValue(ctx, newMInCreation)

	m.R.PointSystem = rel8
	m.R.Loaded.PointSystem = true
	m.R.Series = rel9
	m.R.Loaded.Series = true
...
// Set the model columns to this value
func (m seasonMods) NumGrids(val int32) SeasonMod {
	return SeasonModFunc(func(_ context.Context, o *SeasonTemplate) {
		o.NumGrids = func() int32 { return val }
	})
}

// Set the Column from the function
func (m seasonMods) NumGridsFunc(f func() int32) SeasonMod {
	return SeasonModFunc(func(_ context.Context, o *SeasonTemplate) {
		o.NumGrids = f
	})
}
...
// Clear any values for the column
func (m seasonMods) UnsetNumGrids() SeasonMod {
	return SeasonModFunc(func(_ context.Context, o *SeasonTemplate) {
		o.NumGrids = nil
	})
}
...
// Generates a random value for the column using the given faker
// if faker is nil, a default faker is used
func (m seasonMods) RandomNumGrids(f *faker.Faker) SeasonMod {
	return SeasonModFunc(func(_ context.Context, o *SeasonTemplate) {
		o.NumGrids = func() int32 {
			return random_int32(f)
		}
	})
}
...
func (m seasonMods) WithExistingPointSystem(em *models.PointSystem) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		o.r.PointSystem = &seasonRPointSystemR{
			o: o.f.fromExistingPointSystem(ctx, em),
		}
	})
}
...
func (m seasonMods) WithExistingSeries(em *models.Series) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		o.r.Series = &seasonRSeriesR{
			o: o.f.fromExistingSeries(ctx, em),
		}
	})
}
...
func (m seasonMods) AddExistingEventDriverStandings(existingModels ...*models.EventDriverStanding) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		for _, em := range existingModels {
			o.r.EventDriverStandings = append(o.r.EventDriverStandings, &seasonREventDriverStandingsR{
				o: o.f.fromExistingEventDriverStanding(ctx, em),
			})
		}
	})
}
...
func (m seasonMods) AddExistingEvents(existingModels ...*models.Event) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		for _, em := range existingModels {
			o.r.Events = append(o.r.Events, &seasonREventsR{
				o: o.f.fromExistingEvent(ctx, em),
			})
		}
	})
}
...
func (m seasonMods) AddExistingSeasonCarClasses(existingModels ...*models.SeasonCarClass) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		for _, em := range existingModels {
			o.r.SeasonCarClasses = append(o.r.SeasonCarClasses, &seasonRSeasonCarClassesR{
				o: o.f.fromExistingSeasonCarClass(ctx, em),
			})
		}
	})
}
...
func (m seasonMods) WithSeasonCarModelVariants(number int, related *SeasonCarModelVariantTemplate) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		o.r.SeasonCarModelVariants = []*seasonRSeasonCarModelVariantsR{{
			number: number,
			o:      related,
		}}
	})
...
func (m seasonMods) WithNewSeasonCarModelVariants(number int, mods ...SeasonCarModelVariantMod) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
...
func (m seasonMods) AddSeasonCarModelVariants(number int, related *SeasonCarModelVariantTemplate) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		o.r.SeasonCarModelVariants = append(o.r.SeasonCarModelVariants, &seasonRSeasonCarModelVariantsR{
			number: number,
			o:      related,
		})
	})
...
func (m seasonMods) AddNewSeasonCarModelVariants(number int, mods ...SeasonCarModelVariantMod) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		related := o.f.NewSeasonCarModelVariantWithContext(ctx, mods...)
...
func (m seasonMods) AddExistingSeasonCarModelVariants(existingModels ...*models.SeasonCarModelVariant) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		for _, em := range existingModels {
			o.r.SeasonCarModelVariants = append(o.r.SeasonCarModelVariants, &seasonRSeasonCarModelVariantsR{
...
func (m seasonMods) WithoutSeasonCarModelVariants() SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
...
func (m seasonMods) AddExistingSeasonDriverStandings(existingModels ...*models.SeasonDriverStanding) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		for _, em := range existingModels {
			o.r.SeasonDriverStandings = append(o.r.SeasonDriverStandings, &seasonRSeasonDriverStandingsR{
				o: o.f.fromExistingSeasonDriverStanding(ctx, em),
			})
		}
	})
}
...
func (m seasonMods) WithSeasonDrivers(number int, related *SeasonDriverTemplate) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		o.r.SeasonDrivers = []*seasonRSeasonDriversR{{
			number: number,
			o:      related,
		}}
	})
...
func (m seasonMods) WithNewSeasonDrivers(number int, mods ...SeasonDriverMod) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
...
func (m seasonMods) AddSeasonDrivers(number int, related *SeasonDriverTemplate) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		o.r.SeasonDrivers = append(o.r.SeasonDrivers, &seasonRSeasonDriversR{
			number: number,
			o:      related,
		})
	})
...
func (m seasonMods) AddNewSeasonDrivers(number int, mods ...SeasonDriverMod) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		related := o.f.NewSeasonDriverWithContext(ctx, mods...)
...
func (m seasonMods) AddExistingSeasonDrivers(existingModels ...*models.SeasonDriver) SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
		for _, em := range existingModels {
			o.r.SeasonDrivers = append(o.r.SeasonDrivers, &seasonRSeasonDriversR{
...
func (m seasonMods) WithoutSeasonDrivers() SeasonMod {
	return SeasonModFunc(func(ctx context.Context, o *SeasonTemplate) {
