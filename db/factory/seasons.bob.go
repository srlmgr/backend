	...
	if !isSeasonDriversDone && o.r.SeasonDrivers != nil {
		...
		for _, r := range o.r.SeasonDrivers {
			if r.o.alreadyPersisted {
				...
				err = m.AttachSeasonDrivers(ctx, exec, rel5...)
				if err != nil {
					return err
				}
			}
	...
	if !isSeasonTeamStandingsDone && o.r.SeasonTeamStandings != nil {
		...
		for _, r := range o.r.SeasonTeamStandings {
			if r.o.alreadyPersisted {
				...
				err = m.AttachSeasonTeamStandings(ctx, exec, rel6...)
				if err != nil {
					return err
				}
			}
	...
	if !isTeamsDone && o.r.Teams != nil {
		...
		for _, r := range o.r.Teams {
			if r.o.alreadyPersisted {
				...
				err = m.AttachTeams(ctx, exec, rel9...)
				if err != nil {
					return err
				}
			}
...
func (o *SeasonTemplate) Create(ctx context.Context, exec bob.Executor) (*models.Season, error) {
	...
	if rel7 == nil {
		...
		if o.r.PointSystem.o.alreadyPersisted {
			rel7 = o.r.PointSystem.o.Build()
		} else {
			rel7, err = o.r.PointSystem.o.Create(ctx, exec)
			if err != nil {
				return nil, err
			}
		}
	...
	opt.PointSystemID = omit.From(rel7.ID)

	var rel8 *models.Series
	...
	if rel8 == nil {
		...
		if o.r.Series.o.alreadyPersisted {
			rel8 = o.r.Series.o.Build()
		} else {
			rel8, err = o.r.Series.o.Create(ctx, exec)
			if err != nil {
				return nil, err
			}
		}
	...
	opt.SeriesID = omit.From(rel8.ID)
