...
func (o *RacingSimTemplate) Create(ctx context.Context, exec bob.Executor) (*models.RacingSim, error) {
	...
	newMInCreation["racing_sims:series:series.series_simulation_id_fk"] = m
	newMInCreation["racing_sims:simulation_car_aliases:simulation_car_aliases.simulation_car_aliases_simulation_id_fk"] = m
	newMInCreation["racing_sims:simulation_driver_aliases:simulation_driver_aliases.simulation_driver_aliases_simulation_id_fk"] = m
	newMInCreation["racing_sims:simulation_track_layout_aliases:simulation_track_layout_aliases.simulation_track_layout_aliases_simulation_id_fk"] = m
