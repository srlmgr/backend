...
type teamR struct {
	...
	CarModelVariant     *teamRCarModelVariantR
	Season              *teamRSeasonR
}
...
type teamRCarModelVariantR struct {
...
func (o *TeamTemplate) insertOptRels(ctx context.Context, exec bob.Executor, m *models.Team) error {
	...
	isCarModelVariantDone, _ := teamRelCarModelVariantCtx.Value(ctx)
	if !isCarModelVariantDone && o.r.CarModelVariant != nil {
		ctx = teamRelCarModelVariantCtx.WithValue(ctx, true)
		if o.r.CarModelVariant.o.alreadyPersisted {
			m.R.CarModelVariant = o.r.CarModelVariant.o.Build()
			m.R.Loaded.CarModelVariant = true
		} else {
			var rel5 *models.CarModelVariant
			rel5, err = o.r.CarModelVariant.o.Create(ctx, exec)
			if err != nil {
				return err
			}
			err = m.AttachCarModelVariant(ctx, exec, rel5)
			if err != nil {
				return err
			}
		}
...
func (m teamMods) RandomizeAllColumns(f *faker.Faker) TeamMod {
	return TeamModSlice{
		...
		TeamMods.RandomCarModelVariantID(f),
...
// Set the model columns to this value
func (m teamMods) CarModelVariantID(val null.Val[int32]) TeamMod {
	return TeamModFunc(func(_ context.Context, o *TeamTemplate) {
...
// Set the Column from the function
func (m teamMods) CarModelVariantIDFunc(f func() null.Val[int32]) TeamMod {
	return TeamModFunc(func(_ context.Context, o *TeamTemplate) {
...
// Clear any values for the column
func (m teamMods) UnsetCarModelVariantID() TeamMod {
	return TeamModFunc(func(_ context.Context, o *TeamTemplate) {
...
func (m teamMods) RandomCarModelVariantID(f *faker.Faker) TeamMod {
	return TeamModFunc(func(_ context.Context, o *TeamTemplate) {
...
func (m teamMods) RandomCarModelVariantIDNotNull(f *faker.Faker) TeamMod {
	return TeamModFunc(func(_ context.Context, o *TeamTemplate) {
		o.CarModelVariantID = func() null.Val[int32] {
			if f == nil {
				f = &defaultFaker
...
func (m teamMods) WithCarModelVariant(rel *CarModelVariantTemplate) TeamMod {
	return TeamModFunc(func(ctx context.Context, o *TeamTemplate) {
		o.r.CarModelVariant = &teamRCarModelVariantR{
			o: rel,
		}
	})
}

func (m teamMods) WithNewCarModelVariant(mods ...CarModelVariantMod) TeamMod {
	return TeamModFunc(func(ctx context.Context, o *TeamTemplate) {
...
func (m teamMods) WithExistingCarModelVariant(em *models.CarModelVariant) TeamMod {
	return TeamModFunc(func(ctx context.Context, o *TeamTemplate) {
		o.r.CarModelVariant = &teamRCarModelVariantR{
...
func (m teamMods) WithoutCarModelVariant() TeamMod {
	return TeamModFunc(func(ctx context.Context, o *TeamTemplate) {
