...
func (i simulationDriverAliasIndexes) AsSlice() []index {
	return []index{
		i.SimulationDriverAliasesPkey, i.IdxSimulationDriverAliasesDriverID, i.IdxSimulationDriverAliasesSimulationID, i.SimulationDriverAliasesSimulationIDDriverKeyUnique,
	}
}
...
func (u simulationDriverAliasUniques) AsSlice() []constraint {
	return []constraint{
		u.SimulationDriverAliasesSimulationIDDriverKeyUnique,
	}
}
