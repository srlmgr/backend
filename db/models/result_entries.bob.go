...
func buildResultEntryColumns(tableName string) resultEntryColumns {
	...
	return resultEntryColumns{
		...
		RawCarName:       psql.Quote(tableName, "raw_car_name"),
		RawDriverName:    psql.Quote(tableName, "raw_driver_name"),
		RawTeamName:      psql.Quote(tableName, "raw_team_name"),
		CarNumber:        psql.Quote(tableName, "car_number"),
		IsGuestStarter:   psql.Quote(tableName, "is_guest_starter"),
		TeamDrivers:      psql.Quote(tableName, "team_drivers"),
		StartPosition:    psql.Quote(tableName, "start_position"),
		FinishPosition:   psql.Quote(tableName, "finish_position"),
		LapsCompleted:    psql.Quote(tableName, "laps_completed"),
		QualiLapTimeMS:   psql.Quote(tableName, "quali_lap_time_ms"),
		FastestLapTimeMS: psql.Quote(tableName, "fastest_lap_time_ms"),
		TotalTimeMS:      psql.Quote(tableName, "total_time_ms"),
		Incidents:        psql.Quote(tableName, "incidents"),
		State:            psql.Quote(tableName, "state"),
		AdminNotes:       psql.Quote(tableName, "admin_notes"),
