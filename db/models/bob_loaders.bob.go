...
type preloaders struct {
	...
	CarModelVariant            carModelVariantPreloader
	...
	SeasonCarModelVariant      seasonCarModelVariantPreloader
...
func getPreloaders() preloaders {
	return preloaders{
		...
		CarModelVariant:            buildCarModelVariantPreloader(),
		...
		SeasonCarModelVariant:      buildSeasonCarModelVariantPreloader(),
...
type thenLoaders[Q orm.Loadable] struct {
	...
	CarModelVariant            carModelVariantThenLoader[Q]
	...
	SeasonCarModelVariant      seasonCarModelVariantThenLoader[Q]
...
func getThenLoaders[Q orm.Loadable]() thenLoaders[Q] {
	return thenLoaders[Q]{
		...
		CarModelVariant:            buildCarModelVariantThenLoader[Q](),
		...
		SeasonCarModelVariant:      buildSeasonCarModelVariantThenLoader[Q](),
