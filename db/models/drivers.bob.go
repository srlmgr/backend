...
var Drivers = psql.NewTablex[*Driver, DriverSlice, *DriverSetter]("", "drivers", buildDriverColumns("drivers"), driverScanMapper)
...
func driverScanMapper(ctx context.Context, cols []string) (scan.BeforeFunc, func(any) (*Driver, error)) {
	// resolve the column positions once per query, not per row
	type target struct {
		idx int
		dst func(o *Driver) any
	}
	targets := make([]target, 0, 10)
	for i, col := range cols {
		switch col {
		case "id":
			targets = append(targets, target{i, func(o *Driver) any { return &o.ID }})
		case "frontend_id":
			targets = append(targets, target{i, func(o *Driver) any { return &o.FrontendID }})
		case "external_id":
			targets = append(targets, target{i, func(o *Driver) any { return &o.ExternalID }})
		case "name":
			targets = append(targets, target{i, func(o *Driver) any { return &o.Name }})
		case "is_active":
			targets = append(targets, target{i, func(o *Driver) any { return &o.IsActive }})
		case "last_imported_from":
			targets = append(targets, target{i, func(o *Driver) any { return &o.LastImportedFrom }})
		case "created_at":
			targets = append(targets, target{i, func(o *Driver) any { return &o.CreatedAt }})
		case "updated_at":
			targets = append(targets, target{i, func(o *Driver) any { return &o.UpdatedAt }})
		case "created_by":
			targets = append(targets, target{i, func(o *Driver) any { return &o.CreatedBy }})
		case "updated_by":
			targets = append(targets, target{i, func(o *Driver) any { return &o.UpdatedBy }})
		}
	}
...
func (o DriverSlice) copyMatchingRows(from ...*Driver) {
	fromByPK := make(map[int32]*Driver, len(from))
...
func (os DriverSlice) BookingEntries(mods ...bob.Mod[*dialect.SelectQuery]) BookingEntriesQuery {
	...
	return BookingEntries.Query(append(mods,
		sm.Where(BookingEntries.Columns.DriverID.EQ(PKArgExpr)),
	)...)
}
...
func (os DriverSlice) EventDriverStandings(mods ...bob.Mod[*dialect.SelectQuery]) EventDriverStandingsQuery {
	...
	return EventDriverStandings.Query(append(mods,
		sm.Where(EventDriverStandings.Columns.DriverID.EQ(PKArgExpr)),
	)...)
}
...
func (os DriverSlice) ResultEntries(mods ...bob.Mod[*dialect.SelectQuery]) ResultEntriesQuery {
	...
	return ResultEntries.Query(append(mods,
		sm.Where(ResultEntries.Columns.DriverID.EQ(PKArgExpr)),
	)...)
}
...
func (os DriverSlice) SeasonDriverStandings(mods ...bob.Mod[*dialect.SelectQuery]) SeasonDriverStandingsQuery {
	...
	return SeasonDriverStandings.Query(append(mods,
		sm.Where(SeasonDriverStandings.Columns.DriverID.EQ(PKArgExpr)),
	)...)
}
...
func (os DriverSlice) SeasonDrivers(mods ...bob.Mod[*dialect.SelectQuery]) SeasonDriversQuery {
	...
	return SeasonDrivers.Query(append(mods,
		sm.Where(SeasonDrivers.Columns.DriverID.EQ(PKArgExpr)),
	)...)
}
...
func (os DriverSlice) SimulationDriverAliases(mods ...bob.Mod[*dialect.SelectQuery]) SimulationDriverAliasesQuery {
	...
	return SimulationDriverAliases.Query(append(mods,
		sm.Where(SimulationDriverAliases.Columns.DriverID.EQ(PKArgExpr)),
	)...)
}
...
func (os DriverSlice) TeamDrivers(mods ...bob.Mod[*dialect.SelectQuery]) TeamDriversQuery {
	...
	return TeamDrivers.Query(append(mods,
		sm.Where(TeamDrivers.Columns.DriverID.EQ(PKArgExpr)),
	)...)
}
...
func buildDriverWhere[Q psql.Filterable](cols driverColumns) driverWhere[Q] {
	return driverWhere[Q]{
		...
		R:                driverWhereR[Q]{cols: cols},
	}
}

// driverWhereR holds the relationship-based filters of
// driverWhere under the R namespace — mirroring the model's
// R struct — so they cannot collide with column-based filter fields.
type driverWhereR[Q psql.Filterable] struct {
	cols driverColumns
}
...
func (w driverWhereR[Q]) HasBookingEntries(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(BookingEntries.NameExpr()),
		sm.Where(BookingEntries.Columns.DriverID.EQ(w.cols.ID)),
	)
	q.Apply(filters...)
...
func (w driverWhereR[Q]) HasEventDriverStandings(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(EventDriverStandings.NameExpr()),
		sm.Where(EventDriverStandings.Columns.DriverID.EQ(w.cols.ID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}
...
func (w driverWhereR[Q]) HasResultEntries(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(ResultEntries.NameExpr()),
		sm.Where(ResultEntries.Columns.DriverID.EQ(w.cols.ID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}
...
func (w driverWhereR[Q]) HasSeasonDriverStandings(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(SeasonDriverStandings.NameExpr()),
		sm.Where(SeasonDriverStandings.Columns.DriverID.EQ(w.cols.ID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}
...
func (w driverWhereR[Q]) HasSeasonDrivers(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(SeasonDrivers.NameExpr()),
		sm.Where(SeasonDrivers.Columns.DriverID.EQ(w.cols.ID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}

// HasSimulationDriverAliases filters parents that have a matching SimulationDriverAliases using a
// correlated EXISTS subquery (semi-join). Unlike an INNER JOIN it does not
// multiply parent rows, so no DISTINCT is needed. The optional filters are
// applied to the subquery (i.e. to SimulationDriverAliases).
func (w driverWhereR[Q]) HasSimulationDriverAliases(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(SimulationDriverAliases.NameExpr()),
		sm.Where(SimulationDriverAliases.Columns.DriverID.EQ(w.cols.ID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}

// HasTeamDrivers filters parents that have a matching TeamDrivers using a
// correlated EXISTS subquery (semi-join). Unlike an INNER JOIN it does not
// multiply parent rows, so no DISTINCT is needed. The optional filters are
// applied to the subquery (i.e. to TeamDrivers).
func (w driverWhereR[Q]) HasTeamDrivers(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := psql.Select(
		sm.Columns(psql.Raw("1")),
		sm.From(TeamDrivers.NameExpr()),
		sm.Where(TeamDrivers.Columns.DriverID.EQ(w.cols.ID)),
	)
	q.Apply(filters...)
	return mods.Where[Q]{E: psql.Exists(q)}
}

// NULL-tolerant scan buffer for driverScanMapperNullable:
...
type driverPreloadBuf struct {
	ID               null.Val[int32]
	FrontendID       null.Val[uuid.UUID]
	ExternalID       null.Val[string]
	Name             null.Val[string]
	IsActive         null.Val[bool]
	LastImportedFrom null.Val[string]
...
// driverScanMapperNullable maps the preloaded driver
...
func driverScanMapperNullable(prefix string) scan.Mapper[*Driver] {
	return func(ctx context.Context, cols []string) (scan.BeforeFunc, func(any) (*Driver, error)) {
		// resolve the column names once per query, not per row
		type target struct {
			idx int
			dst func(b *driverPreloadBuf) any
		}
		targets := make([]target, 0, 10)
		for i, col := range cols {
			...
			switch name {
			case "id":
				targets = append(targets, target{i, func(b *driverPreloadBuf) any { return &b.ID }})
			case "frontend_id":
				targets = append(targets, target{i, func(b *driverPreloadBuf) any { return &b.FrontendID }})
			case "external_id":
				targets = append(targets, target{i, func(b *driverPreloadBuf) any { return &b.ExternalID }})
			case "name":
				targets = append(targets, target{i, func(b *driverPreloadBuf) any { return &b.Name }})
			case "is_active":
				targets = append(targets, target{i, func(b *driverPreloadBuf) any { return &b.IsActive }})
			case "last_imported_from":
				targets = append(targets, target{i, func(b *driverPreloadBuf) any { return &b.LastImportedFrom }})
			case "created_at":
				targets = append(targets, target{i, func(b *driverPreloadBuf) any { return &b.CreatedAt }})
			case "updated_at":
				targets = append(targets, target{i, func(b *driverPreloadBuf) any { return &b.UpdatedAt }})
			case "created_by":
				targets = append(targets, target{i, func(b *driverPreloadBuf) any { return &b.CreatedBy }})
			case "updated_by":
				targets = append(targets, target{i, func(b *driverPreloadBuf) any { return &b.UpdatedBy }})
			}
		}
		...
		buf := new(driverPreloadBuf)
		return func(row *scan.Row) (any, error) {
				for _, t := range targets {
					row.ScheduleScanByIndex(t.idx, t.dst(buf))
				}
				return buf, nil
			}, func(link any) (*Driver, error) {
				buf := link.(*driverPreloadBuf)
				...
				o.LastImportedFrom = buf.LastImportedFrom
