...
func buildSeasonColumns(tableName string) seasonColumns {
	...
	return seasonColumns{
		...
		SeriesID:       psql.Quote(tableName, "series_id"),
		PointSystemID:  psql.Quote(tableName, "point_system_id"),
		Name:           psql.Quote(tableName, "name"),
		StartsAt:       psql.Quote(tableName, "starts_at"),
		EndsAt:         psql.Quote(tableName, "ends_at"),
		SkipEvents:     psql.Quote(tableName, "skip_events"),
		HasTeams:       psql.Quote(tableName, "has_teams"),
		TeamPointsTopN: psql.Quote(tableName, "team_points_top_n"),
		IsTeamBased:    psql.Quote(tableName, "is_team_based"),
		IsMulticlass:   psql.Quote(tableName, "is_multiclass"),
