		...
		SeasonTeamStandings: func(mods ...bob.Mod[*dialect.SelectQuery]) psql.Preloader {
			return countPreloader[*Season]("SeasonTeamStandings", func(parent string) bob.Expression {
				...
				subqueryMods := []bob.Mod[*dialect.SelectQuery]{
					...
					sm.From(SeasonTeamStandings.Name()),
...
func (os SeasonSlice) LoadCountSeasonTeamStandings(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	batchMods := []bob.Mod[*dialect.SelectQuery]{
		...
		// Single-hop: FROM related table directly
		sm.From(SeasonTeamStandings.NameAs()),
	...
	return seasonJoins[Q]{
		...
		SeasonDrivers: modAs[Q, seasonDriverColumns]{
			...
			f: func(to seasonDriverColumns) bob.Mod[Q] {
				...
				{
					mods = append(mods, dialect.Join[Q](typ, SeasonDrivers.Name().As(to.Alias())).On(
						to.SeasonID.EQ(cols.ID),
					))
				}
