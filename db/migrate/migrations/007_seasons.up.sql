...
CREATE TABLE season_car_model_variants (
	-- ugly workaround. don't need a pk here, but bob runs into errors creating dberrors text without it
	id serial PRIMARY KEY,
    season_id integer NOT NULL,
...
ALTER TABLE season_car_model_variants
    ADD CONSTRAINT season_car_model_variants_car_model_variant_id_fk
    FOREIGN KEY (car_model_variant_id) REFERENCES car_model_variants (id);

ALTER TABLE season_car_model_variants
    ADD CONSTRAINT season_car_model_variants_car_model_variant_id_season_id_unique
    UNIQUE (car_model_variant_id, season_id);

ALTER TABLE season_car_model_variants
    ADD CONSTRAINT season_car_model_variants_season_id_fk
    FOREIGN KEY (season_id) REFERENCES seasons (id);
